...
export function enableDQS(skinnedMesh, log) {
    ...
    //hack with isSkinnedMesh boolean to dodge default skinning ; material.skinning = false is not supported with nodeMaterials
    ...
    skinnedMeshList.push(skinnedMesh);
}
export function updateDQS() {
    skinnedMeshList.forEach((mesh) => {
        ...
        //fixes inaccurate viewport clipping
